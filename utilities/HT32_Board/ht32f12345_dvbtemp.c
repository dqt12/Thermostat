/*********************************************************************************************************//**
 * @file    ht32f12345_dvbtemp.c
 * @version $Rev:: 117          $
 * @date    $Date:: 2016-06-03 #$
 * @brief   This file provides firmware functions to manage LEDs, push-buttons
 *          and COM ports and is available on ht32f12345_dvbtemp Development Board.
 *************************************************************************************************************
 * @attention
 *
...
/** @defgroup HT32F12345_DVBTEMP HT32F12345_DVBTEMP
  * @brief Provides firmware functions to manage LEDs, push-buttons
  *        and COM ports and is available on HT32F12345 Development Board.
  * @{
  */
...
/* Global variables ----------------------------------------------------------------------------------------*/
/** @defgroup HT32F12345_DVBTEMP_Global_Variable HT32F12345 DVB global variables
  * @{
  */

  HT_GPIO_TypeDef* const GPIO_PORT[GPIO_PORT_NUM] = {
    HT_GPIOA, HT_GPIOB, HT_GPIOC, HT_GPIOD
  };

  const u8 LED_GPIO_ID[LEDn] = {LED1_GPIO_ID, LED2_GPIO_ID};
  const u16 LED_GPIO_PIN[LEDn] = {LED1_GPIO_PIN, LED2_GPIO_PIN};
  const AFIO_MODE_Enum LED_AFIO_MODE[LEDn] = {LED1_AFIO_MODE, LED2_AFIO_MODE};

  const u8 BUTTON_GPIO_ID[BUTTONn] = {WAKEUP_BUTTON_GPIO_ID, KEY1_BUTTON_GPIO_ID, KEY2_BUTTON_GPIO_ID, KEY3_BUTTON_GPIO_ID, KEY4_BUTTON_GPIO_ID};
  const u16 BUTTON_GPIO_PIN[BUTTONn] = {WAKEUP_BUTTON_GPIO_PIN, KEY1_BUTTON_GPIO_PIN, KEY2_BUTTON_GPIO_PIN, KEY3_BUTTON_GPIO_PIN, KEY4_BUTTON_GPIO_PIN};
  const AFIO_MODE_Enum BUTTON_AFIO_MODE[BUTTONn] = {
    WAKEUP_BUTTON_AFIO_MODE, KEY1_BUTTON_AFIO_MODE, KEY2_BUTTON_AFIO_MODE, KEY3_BUTTON_AFIO_MODE, KEY4_BUTTON_AFIO_MODE
  };

  const u8 BUTTON_EXTI_CH[BUTTONn] = {
    WAKEUP_BUTTON_EXTI_CHANNEL, KEY1_BUTTON_EXTI_CHANNEL, KEY2_BUTTON_EXTI_CHANNEL, KEY3_BUTTON_EXTI_CHANNEL, KEY4_BUTTON_EXTI_CHANNEL
  };
...
/* Global functions ----------------------------------------------------------------------------------------*/
/** @defgroup HT32F12345_DVBTEMP_Global_Functions HT32F12345 DVB global functions
  * @{
  */
/*********************************************************************************************************//**
...
/* Private functions ---------------------------------------------------------------------------------------*/
/** @defgroup HT32F12345_DVBTEMP_Private_Functions HT32F12345 DVB private functions
  * @{
  */
/*********************************************************************************************************//**
