...
//  printf("\nCardType : %u", cardinfo->CardType);
//  printf("\nCapacity : %u MB", cardinfo->CardCapacity/(1024*1024));
//  printf("\nBlockSize: %u", cardinfo->CardBlockSize);
//  printf("\nRCA      : 0x%04x", cardinfo->RCA);
//  printf("\nManufID  : %u", cardinfo->SD_cid.ManufactID);
