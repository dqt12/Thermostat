...
typedef enum
{
  ...
  SD_CMD_RSP_TIMEOUT                 = (3), /*!< Command response timeout    ÃüÁîÏìÓ¦³¬Ê±                               */
...
#define SDCARD_SD_CD_GPIO_PORT      (HT_GPIOA)
#define SDCARD_SD_CD_GPIO_PIN       (GPIO_PIN_6)
...
#define SDCARD_SD_CLK_GPIO_PORT     (HT_GPIOA)
...
#define SDCARD_SD_CMD_GPIO_PORT     (HT_GPIOA)
...
#define SDCARD_SD_DAT0_GPIO_PORT    (HT_GPIOC)
...
#define SDCARD_SD_DAT1_GPIO_PORT    (HT_GPIOC)
...
#define SDCARD_SD_DAT2_GPIO_PORT     (HT_GPIOC)
...
#define SDCARD_SD_DAT3_GPIO_PORT    (HT_GPIOC)
