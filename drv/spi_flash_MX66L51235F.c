...
//    u8 buf1[1024*8];
    ...
    SPI_FLASH_BufferRead(buf, 0, 2048); //0~2K
		SPI_FLASH_BufferRead(buf, 1024*2, 2048);  //2k~4k 
		SPI_FLASH_BufferRead(buf, 1024*4, 2048);   //4k~8k
		SPI_FLASH_BufferRead(buf, 1024*8, 2048);   //8k~10k
