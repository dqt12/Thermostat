 ...
 */
#if (defined(USE_HT32F1655_56) | defined(USE_HT32F1653_54))
 ...
 *     @arg FLASH_WAITSTATE_3 : three wait state (For HT32F1xxxx only)
 * @retval None
 ************************************************************************************************************/
